...
/**
 * POST /api/accounting/journal-entries/[id]/approve - PENDING_APPROVAL -> APPROVED.
 */
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const entry = await JournalService.approve(id, actorFromSession(session), expectedVersion);
