...
> - Deferred manual gate (needs Docker Desktop): compose up → `npm run db:accounting:create` → `npm run db:accounting:migrate` → seed → exercise AR/AP/report flows live
> - **Next: Part 6 — Admin UI**
